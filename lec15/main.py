...
if options.solve == True:
    ...
    if options.policy == 'SJF':
		#2012011333 2012011306  (SJF)
        elist = sorted(joblist, key=lambda joblist : joblist[1])
        print 'Execution trace:'
        t = 0.0
        for mission in elist:
            print '  [ time', t, '] Run job', mission[0], 'for', mission[1], 'secs ( DONE at', mission[1] + t, ')'
            t = t + mission[1]
        ...
        responseSum   = 0.0
        for mission in elist:
            print '  Job', mission[0], '--', 'Response:', t, ' Turnaround:', mission[1] + t, ' Wait:', t
            count = count + 1
            responseSum = responseSum + t
            turnaroundSum = turnaroundSum +  mission[1] + t
            waitSum = waitSum + t
            t = t + mission[1]
        print '\n  Average -- Response:', responseSum/count, ' Turnaround:',turnaroundSum/count, ' Wait:', waitSum/count
    	pass
